...
Download the gstreamer framework from here: http://gstreamer.freedesktop.org/data/pkg/osx. Supported version is 1.18.5. QGC may work with newer version, but it is untested.

You need two packages:
- [gstreamer-1.0-devel-1.18.5-x86_64.pkg](https://gstreamer.freedesktop.org/data/pkg/osx/1.18.5/gstreamer-1.0-devel-1.18.5-x86_64.pkg)
- [gstreamer-1.0-1.18.5-x86_64.pkg](https://gstreamer.freedesktop.org/data/pkg/osx/1.18.5/gstreamer-1.0-1.18.5-x86_64.pkg)
